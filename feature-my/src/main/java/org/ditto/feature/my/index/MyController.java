...
//        headerModel_.addTo(this);
        ...
        add(new ItemMyWordMemoryHeaderModel_().id("memoryheader_one"));
        for (int i = 0; i < 8; i++) {
            add(new ItemMyWordMemoryModel_().id("memory_one" + i));
        }
        add(new ItemMyWordMemoryHeaderModel_().id("memoryheader_two"));
        for (int i = 0; i < 8; i++) {
            add(new ItemMyWordMemoryModel_().id("memory_two" + i));
        }
        add(new ItemMyWordMemoryHeaderModel_().id("memoryheader_three"));
        for (int i = 0; i < 8; i++) {
