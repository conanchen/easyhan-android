...
public class PinyinKeyboard {
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (focusCurrent == null || !EditText.class.isInstance(focusCurrent)) return;
     ...
     */
    public PinyinKeyboard(Activity host, int viewid, int layoutid) {
        mHostActivity = host;
    ...
    /**
     * Returns whether the PinyinKeyboard is visible.
     */
    ...
    /**
     * Make the PinyinKeyboard visible, and hide the system keyboard for view v.
     */
    ...
    /**
     * Make the PinyinKeyboard invisible.
     */
